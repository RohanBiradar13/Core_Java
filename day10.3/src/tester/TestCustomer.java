				...
				try {
					...
					case 1:
						if (counter < customers.length) {
							...
							Customer c= checkForDuplicate(customers, sc.next(), sc.next(), sc.next(), amount=sc.nextDouble(), sc.next(),sc.next());
							System.out.println("Enter the Adhar Card details ->Adhar Card Number, Created Date");
